...
\textbf{DEAM} используется для обучения голов arousal\_cls / valence\_cls (3 класса каждая, дискретизация порогами $\pm 0{,}2$) и регрессионных голов.

\textbf{Harmonix Set} маппинг 17$\to$6 классов сегментов:
...
\textbf{GTZAN} --- жанры: blues, classical, country, disco, hiphop, jazz, metal, pop, reggae, rock (по 100 треков).
