...
мультизадачный подход к объединению четырёх задач (сегментация,
возбуждение, валентность, жанр).%
\result{%
...
PANNs\,+\,BiLSTM, AST~--- для оценки вклада временного
моделирования, предварительного обучения и трансформерной
парадигмы.%
\result{%
